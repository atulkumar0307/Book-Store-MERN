...
function Navbar() {
  ...
  return (
    <div className={`px-w-screen-2xl container px-auto md:px-20 px-4 fixed top-0 right-0 left-0 z-50 dark:bg-slate-900 dark:text-white
      ${sticky?"sticky-navbar shadow-md bg-base-200 duration-200 transition-all ease-in-out dark:bg-slate-900 dark:text-white":""}`}>
      <div className="navbar">
        <div className="navbar-start">
          ...
          <Link to="/" className="text-2xl font-bold cursor-pointer px-2">BookStore</Link>
        </div>
        <div className="navbar-end">
          ...
          <div className="hidden md:block">
            <label className="px-3 py-2 border-0.5 border-gray-500 rounded-md flex items-center gap-2">
          ...
          <div>
          <label className="swap swap-rotate mt-1 px-4">
          ...
          </div>
          {
            authUser?(<Logout/>):
           ( <div>
              <a className="bg-gray-700 text-white px-4 py-2  rounded-md cursor-pointer hover:bg-slate-600 duration-300"
